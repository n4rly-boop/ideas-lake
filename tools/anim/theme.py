...
def portrait():
    """Вертикальный кадр 800×850.

    Ставится из модуля сцены, а не флагом -r: присваивание идёт после
    разбора командной строки и поэтому переживает -qh. Рисуем вдвое
    крупнее цели — на нативных 800 px контур рвётся.
    """
    config.pixel_width, config.pixel_height = 1600, 1700
    config.frame_width, config.frame_height = 8.0, 8.5
