"""Write path, вертикальный кадр 800×850: источник → тезис → идея на записи.

Раскладка своя, а не обрезка 16:9: в колонку 800×850 из широкого кадра
влезает 67–82 % рисунка, и срезается ровно суть — источник и запись в
граф. Поэтому поток развёрнут сверху вниз, а подписи ушли к бортам.
"""
