"""Agent lake, вертикальный кадр 800×850 — то же, что в agent_lake.py.

Озеро сверху, агент под ним, веб сбоку, выдача внизу строкой. Развилка
та же: ответ уходит в эволюцию сразу, найденное параллельно ложится в
озеро (`lake/api/routes.py:246`, `lake/research/agent.py:330-365`).
"""
...
class AgentLakeV(PipelineScene):
    def construct(self):
        # --- озеро уже есть -------------------------------------------------------
