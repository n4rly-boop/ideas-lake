...
зависимостей, ни JS-фреймворка. Восемь вкладок: **retrieve** (в том числе оба плеча абляции
рядом), сырой **индекс** с колонками BM25/вектор, **идеи** постранично с рёбрами и правкой
полей через `PATCH`, **тезисы** и **источники** с фильтрами, **ингест и ops** (`/fetch`, фазы,
суд, пересборка индекса, выгрузка vault, очередь заданий, staging, отказы арбитра), **граф**
идея—идея с раскладкой в браузере и **прямой вызов** любой ручки.
